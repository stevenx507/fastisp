...
const TechSupport: React.FC = () => {
  const items = [
    "Cola de tickets y SLA (usa módulo Tickets)",
    "Asignación a técnicos y escalamiento",
    "Historial de acciones (placeholder)"
  ]
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Integración con tickets (placeholder).</p>
        </div>
      </div>
