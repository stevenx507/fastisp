...
const HotspotCards: React.FC = () => {
  const items = [
    "Gestión de vouchers Hotspot",
    "Impresión/QR y control de sesiones",
    "Stats de consumo por voucher"
  ]
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Placeholder para vouchers.</p>
        </div>
      </div>
