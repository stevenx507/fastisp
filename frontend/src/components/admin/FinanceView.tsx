...
const FinanceView: React.FC = () => {
  const items = [
    "Cobros, cuentas por cobrar y cortes programados",
    "Exportar cartera y abonos (placeholder)",
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Placeholder de finanzas y cortes.</p>
        </div>
      </div>
