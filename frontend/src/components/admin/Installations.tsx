...
const Installations: React.FC = () => {
  const items = [
    "Agenda, técnicos asignados y estado de instalación",
    "Checklist de CPE/Router y coordenadas",
    "Generación de orden de trabajo PDF (pendiente)"
  ]
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Planifica y ejecuta instalaciones (placeholder).</p>
        </div>
      </div>
