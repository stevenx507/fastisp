...
const ScreenAlerts: React.FC = () => {
  const items = [
    "Mensajes en pantalla para clientes conectados",
    "Plantillas rápidas (corte por mora, mantenimiento)",
    "Segmentos: por plan, router o etiqueta"
  ]
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Placeholder para banners y notificaciones.</p>
        </div>
      </div>
