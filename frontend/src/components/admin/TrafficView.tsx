...
const TrafficView: React.FC = () => {
  const items = [
    "Consumo agregado por cliente/plan (placeholder)",
    "Picos de ancho de banda y top talkers",
    "Exportar CSV para NOC"
  ]
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <h2 className="text-2xl font-bold text-gray-900">Tráfico</h2>
          <p className="text-sm text-gray-500">Resumen básico de tráfico (placeholder).</p>
        </div>
      </div>
